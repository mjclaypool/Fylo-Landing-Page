...
export default function Testimonials() {
  ...
  return (
    <div className="flex justify-center gap-10 my-32 px-24">
      {testimonialsList.map(card => (
        <div key={card.id} className="max-w-[362px] bg-dark-blue-test font-open-sans text-stone-200 pt-10 px-8">
          ...
          <div className="flex gap-2 items-center py-6">
            ...
            <div>
              <h4 className="text-[11px] text-white font-semibold tracking-wider">{card.name}</h4>
