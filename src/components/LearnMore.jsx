  ...
  return (
    <div className="flex flex-col lg:flex-row gap-9 lg:gap-16 items-center my-28 lg:my-24 px-7 lg:px-24">
      ...
      <div>
        ...
        <div className="inline-block cursor-pointer gap-1 border-b-2 border-b-cyan-accent hover:border-b-white">
          <p className="inline font-open-sans text-xs lg:text-base py-1 text-cyan-accent hover:text-white">See how Fylo works</p>
          <img src={arrowIcon} alt="Arrow icon" className="inline h-[16px] mx-1 object-contain" />
        </div>
      </div>
    </div>
  )
