...
export default function Hero() {
  return (
    <div className="flex flex-col text-white items-center text-center lg:mt-0 mb-24 lg:mb-32 px-8">
      <img src={heroImg} alt="Introduction illustration" className="w-[714px] object-contain mb-7" />
